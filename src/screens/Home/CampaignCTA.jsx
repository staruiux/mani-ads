...
export default function CampaignCTA() {
  ...
  return (
    ...
    py-12 hover:py-20 transition-all duration-500 ease-out
    ${hoverLocked ? "py-20" : ""}
  `}
          onMouseEnter={() => setHoverLocked(true)}
        >
          <div className="flex flex-col md:flex-row items-center gap-12 px-8 md:px-14">
            <div className="relative w-65 h-65 md:w-85 md:h-85 shrink-0">
              <img
                src={bgImage}
                alt=""
                className={`
    ...
    group-hover:scale-130 group-hover:left-12
    ${hoverLocked ? "scale-130 left-12" : ""}
  `}
              />
    ...
    ${hoverLocked ? "scale-200 -translate-x-2" : ""}
  `}
              />
              ...
              <img
                ...
                className={`
                  ...
                  ${hoverLocked ? "scale-200 -translate-y-2" : ""}
                `}
              />
              ...
              <img
                ...
                className={`
                  ...
                  ${hoverLocked ? "scale-300 translate-x-2" : ""}
                `}
              />
    ...
    ${hoverLocked ? "scale-105" : ""}
  `}
              />
            </div>

            <div className="flex-1 text-center md:text-left transition-all duration-500 ease-out  pl-18 pr-30">
              <h2
                style={{ color: "#000000" }}
