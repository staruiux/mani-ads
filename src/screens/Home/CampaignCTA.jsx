        ...
        <section className="w-full bg-[#F2F2F2] py-16">
            <div className="w-[90%] mx-auto px-6">
                ...
                "
                        ...
                        <div className="flex-1 text-center md:text-left transition-all duration-500 ease-out group-hover:translate-x-2">
                            <h2 className="text-2xl md:text-3xl font-semibold text-[#111111] leading-snug">
                                <span className="underline underline-offset-4">
                                    Uncertain
                                </span>{" "}
                                where to begin? Let us craft the ideal campaign for you.
                            </h2>

                            <p className="mt-4 text-[#555555] text-sm md:text-base max-w-2xl">
                            ...
                            <div className="mt-8 transition-all duration-500 group-hover:translate-y-2">
                                <button className="bg-[#E63946] text-white px-8 py-3 rounded-lg text-sm font-medium hover:bg-[#d62f3c] transition-colors">
                                    Get Started
                                </button>
                            </div>
                        </div>
